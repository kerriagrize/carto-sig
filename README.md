...
_Cours du Bachelor GSE 1ère année, semestre d'automne 2018._
...
__Documents de cours:__ [http://moodle.unil.ch/course/view.php?id=12417](http://moodle.unil.ch/course/view.php?id=12417)

__Q&A / Discussions / Annonces__: [carto-sig-18.slack.com](https://carto-sig-18.slack.com). Utilisez [ce lien](https://join.slack.com/t/carto-sig-18/signup) pour joindre le forum (il faut utiliser votre adresse UNIL pour pouvoir joindre).
...
:-------:|:-----:| --------------------|---------
1        | 19.9. | _Programme du cours, pédagogie, exigences, évaluation._<br>__Cartographie: le cadre général.__<br>Carte topographique versus carte thématique. Notion d’échelle. | __Ex. 1:__ Prise en main de Google Earth.<br>Questions relatives à la carte et l’échelle cartographique.
2        | 26.9.  | __Modélisation du territoire__<br>Modes raster et vecteur. Notion de couches.  | __Ex. 2__:  Prise en main de QGIS. Explorer les modes raster et vecteur.
3        | 3.10.  | __Projections et systèmes de coordonnées__  | __Ex. 3:__ Projections et systèmes de coordonnées. Exercice dans QGIS.
4        | 10.10. | __Fond de carte et généralisation cartographique__  | __Ex. 4:__ Prise en main d’Illustrator. Préparer le fond de carte.<br>__Explications travail pratique 1__
5        | 17.10. | __Les données attributaires__<br>Tableaux de données, l'information statistique, discrétisation cartographique. | __Ex. 5:__ Construction d'un tableau de données, calcul d'indicateurs statistiques (moyenne, écart-type, etc.). Discrétisation.
6        | 24.10. | __Le langage cartographique__<br> Variables visuelles. | __Ex. 6:__  Exercice de sémiologie graphique.
7        | 31.10.  | __Techniques de représentation cartographique__<br>Types de cartes thématiques.  | __Ex. 7:__  Exercice de représentation cartographique. Créer une carte choroplèthe et une carte en symboles proportionnels.
8        | 7.11.  | Pas de cours (inter-semestre)
9        | 14.11. | -- | __Délai de rendu du travail pratique 1__<br>__Explications travail pratique 2__
10       | 21.11. | __Légende cartographique et les couleurs__<br>Légende juste et informative. Modèles de couleurs (CMYK, RGB, HSL etc.). Sélection d’une palette de couleurs. | --
11       | 28.11. | __Mise en scène__<br>Éléments d’habillage, communication efficace, surcharge d’information, distraction visuelle. | --
12       | 5.12.  | __Systèmes d’information géographique__<br>Fonctions de base d’un SIG. Comparaison avec la cartographie. | __Ex. 10:__ Construction d'un fond de carte avec le SIG.
13       | 12.12. | __Contrôle écrit__ | 
14       | 19.12. |  | __Délai de rendu travail pratique 2__

## 7. Exercices
Les cours théoriques sont accompagnés par des exercices individuels. Les exercices sont en grande partie à faire en dehors des heures de cours. Les questions peuvent être posées le plus facilement sur [Slack](https://carto-sig-18.slack.com), dans le canal _#general_. Dans la limite du temps disponible, il est aussi possible de poser des questions à la fin du cours.

Certains exercices se font sur ordinateur. Des questions peuvent alors être posées de préférence sur [Slack](https://carto-sig-18.slack.com), ou pendant les sessions de questions-réponses en salle informatique (ces sessions seront annoncées sur Slack).
